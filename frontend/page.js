    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Learn about Next.js in an interactive course with&nbsp;quizzes! Ready to learn champ!?
          </p>
        </a>
...
const SignUp = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}>
      <form style={{ maxWidth: '500px', width: '100%', padding: '20px', border: '2px solid #ccc', borderRadius: '5px' }} onSubmit={handleSubmit}>
        <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Sign Up for ImpactBoard</h2>
        <div style={{ marginBottom: '10px' }}>
          ...
          <input
            ...
            //required
            style={{ color: '#fffefc', width: '100%', padding: '5px', fontSize: '16px' }}
          />
        </div>
