...
const SignUp = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // Perform any sign-up logic here, e.g., API calls, form validation, etc.
    console.log('Email:', email);
    console.log('Password:', password);

    // In a real-world scenario, perform actual user registration and verification here.
...
<div>
     ...
     <img
      ...
      {/* Navbar at the top */}
      <nav style={{ backgroundColor: '#ffffff', padding: '10px', marginBottom: '30px', }}>
